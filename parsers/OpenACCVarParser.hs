{-# OPTIONS_GHC -w #-}
module OpenACCVarParser (parseACCArgLine) where
...
action_15 (32) = happyShift action_38
action_15 _ = happyFail

action_16 (25) = happyShift action_35
action_16 (26) = happyShift action_36
action_16 (27) = happyShift action_37
action_16 (12) = happyGoto action_34
...
action_18 (32) = happyShift action_30
action_18 (35) = happyShift action_31
action_18 _ = happyFail

action_19 _ = happyReduce_8

action_20 (29) = happyShift action_27
action_20 (30) = happyShift action_28
...
action_25 (30) = happyShift action_28
...
action_29 (10) = happyGoto action_44
...
happyReduction_1 ((HappyAbsSyn14  happy_var_7) `HappyStk`
	...
	happyRest)
	 = HappyAbsSyn4
		 (MkVarDecl (MkVarType happy_var_1 happy_var_2) happy_var_3 happy_var_4 (listFlatter happy_var_6) happy_var_7 True
	) `HappyStk` happyRest
...
happyReduction_5 (_ `HappyStk`
	(HappyTerminal (TokenNumber happy_var_4)) `HappyStk`
	_ `HappyStk`
	_ `HappyStk`
	_ `HappyStk`
	happyRest)
...
happyReduction_16 (HappyTerminal (TokenNumber happy_var_1))
	 =  HappyAbsSyn10
		 (Const happy_var_1
	)
...
happyReduction_17 (HappyTerminal (TokenVarName happy_var_1))
	 =  HappyAbsSyn10
		 (Var happy_var_1
	)
...
happyReduction_24 (HappyTerminal (TokenVarName happy_var_3))
	_
...
happyNewToken action sts stk (tk:tks) =
	...
	case tk of {
	TokenReal -> cont 16;
	TokenInteger -> cont 17;
	TokenKind -> cont 18;
	TokenDimension -> cont 19;
	TokenIntent -> cont 20;
	TokenArgMode -> cont 21;
	TokenRead -> cont 22;
	TokenWrite -> cont 23;
	TokenReadWrite -> cont 24;
	TokenIn -> cont 25;
	TokenOut -> cont 26;
	TokenInOut -> cont 27;
	TokenEq -> cont 28;
	...
	TokenRParen -> cont 32;
	TokenColon -> cont 33;
	TokenDoubleColon -> cont 34;
	TokenComma -> cont 35;
	TokenNumber happy_dollar_dollar -> cont 36;
	TokenVarName happy_dollar_dollar -> cont 37;
	_ -> happyError' (tk:tks)
	}
