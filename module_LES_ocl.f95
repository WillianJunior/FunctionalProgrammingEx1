...
call oclWrite3DFloat ArrayBuffer(cn1_buf, cn1_sz, cn1 )
call oclWrite1DFloat ArrayBuffer(cn234ls_buf, cn234ls_sz, cn234ls )
call oclWrite4DFloat ArrayBuffer(cov_buf, cov_sz, cov )
call oclWrite4DFloat ArrayBuffer(diu_buf, diu_sz, diu )
call oclWrite1DFloat ArrayBuffer(dx1_buf, dx1_sz, dx1 )
call oclWrite1DFloat ArrayBuffer(dxs_buf, dxs_sz, dxs )
call oclWrite1DFloat ArrayBuffer(dy1_buf, dy1_sz, dy1 )
call oclWrite1DFloat ArrayBuffer(dys_buf, dys_sz, dys )
call oclWrite1DFloat ArrayBuffer(dzn_buf, dzn_sz, dzn )
call oclWrite1DFloat ArrayBuffer(dzs_buf, dzs_sz, dzs )
call oclWrite4DFloat ArrayBuffer(fgh_buf, fgh_sz, fgh )
call oclWrite4DFloat ArrayBuffer(fgh_old_buf, fgh_old_sz, fgh_old )
call oclWrite4DFloat ArrayBuffer(mask1_buf, mask1_sz, mask1 )
call oclWrite1DInt ArrayBuffer(n_state_buf, n_state_sz, n_state )
call oclWrite4DFloat ArrayBuffer(nou_buf, nou_sz, nou )
call oclWrite3DFloat ArrayBuffer(p_buf, p_sz, p )
call oclWrite3DFloat ArrayBuffer(rhs_buf, rhs_sz, rhs )
call oclWrite3DFloat ArrayBuffer(sm_buf, sm_sz, sm )
call oclWrite4DFloat ArrayBuffer(uvw_buf, uvw_sz, uvw )
call oclWrite1DFloat ArrayBuffer(z2_buf, z2_sz, z2 )
